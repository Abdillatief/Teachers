...
export const translations = {
  ar: {
    ...
    navStudents: "الطلاب والدارسون",
    navTeachers: "المعلمون والمشرفون",
    navSessions: "الحصص والسجلات",
    navTodaySessions: "الحصص الجارية اليومية",
    navSchedule: "الجدول الأسبوعي",
    navCalendar: "التقويم التفاعلي",
    navSalary: "الراتب والمستحقات",
    navReports: "التقارير والإحصائيات",
    navSubscriptions: "الاشتراكات والباقات",
    navPayments: "المستحقات المالية",
    navSettings: "إعدادات الأكاديمية",
    navNotifications: "مركز الإشعارات",
    navArchive: "أرشيف الطلاب",
    navTrash: "سلة المهملات",
    navPermissions: "الصلاحيات والأدوار",
    navRequests: "طلبات التسجيل",
  ...
  en: {
    ...
    navSessions: "Sessions Log",
    navTodaySessions: "Today's Sessions",
    navSchedule: "Weekly Schedule",
    navCalendar: "Interactive Calendar",
    navSalary: "Salary & Dues",
    navReports: "Reports & Stats",
    navSubscriptions: "Subscriptions & Plans",
    navPayments: "Payments",
    navSettings: "Academy Settings",
    navNotifications: "Notifications Center",
    navArchive: "Student Archive",
    navTrash: "Trash Bin",
    navPermissions: "Permissions & Roles",
    navRequests: "Registration Requests",
    navLogout: "Sign Out",
