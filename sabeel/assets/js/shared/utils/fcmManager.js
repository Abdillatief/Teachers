...
export async function initAndSyncFCM(user, role = null) {
  ...
  // Always associate OneSignal External ID with user UID (Median Bridge + Web SDK + Retry on load)
  loginMedianOneSignal(user, userRole, user.email).catch(e => console.warn('[Push Manager] OneSignal link warning:', e));
