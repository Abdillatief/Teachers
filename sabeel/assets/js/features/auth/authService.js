...
import { loginMedianOneSignal, logoutMedianOneSignal } from '../../shared/utils/medianBridge.js';
...
export function protectRoute(requiredRole) {
  ...
  auth.onAuthStateChanged(async (user) => {
    ...
    try {
      ...
      // Ensure OneSignal login runs immediately after Firebase Auth and syncs subscription to Firestore
      loginAndSyncOneSignal(user, userRole).catch(e => console.warn('[AuthService] OneSignal sync warning:', e));
