  ...
  if (loginForm) {
    loginForm.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        // Immediately link OneSignal with user.uid upon successful sign-in
        loginMedianOneSignal(user, 'teacher', email);
        ...
        if (role === 'admin') {
          // Link OneSignal external ID with admin role
          loginMedianOneSignal(user, 'admin', email);
          ...
          // Link OneSignal external ID with teacher role
          loginMedianOneSignal(user, 'teacher', email);
